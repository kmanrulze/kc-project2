...
// Clients:
  ...
  updateUser$(clientId: string, clientInfo: Client) {
    return this.http.put(`https://dbndapi.azurewebsites.net/api/client/${clientId}/update`, clientInfo);
  }
...
// Characters (of a client):
  ...
  createCharacter$(clientId: string, character: Character): Observable<any> {
    return this.http.post(`https://dbndapi.azurewebsites.net/api/client/${clientId}/characters/new`, character);
  }
  ...
  updateCharacter$(clientId: string, characterId: string, character: Character) {
    return this.http.put(`https://dbndapi.azurewebsites.net/api/client/${clientId}/characters/${characterId}`, character);
  }
  ...
  deleteCharacter$(clientId: string, characterId: string): Observable<any> {
    return this.http.delete(`https://dbndapi.azurewebsites.net/api/client/${clientId}/characters/${characterId}/delete`);
  }

// Games (of a client):
  // POST    Create new game: api/client/{clientId}/games/new
  createGame$(clientId: string, game: Game): Observable<any> {
    return this.http.post(`https://dbndapi.azurewebsites.net/api/client/${clientId}/games/new`, game);
  }
  
  // GET     Get client's games: api/client/{clientId}/games
  getUserGames$(clientId: string): Observable<any> {
    return this.http.get(`https://dbndapi.azurewebsites.net/api/client/${clientId}/games`);
  }

  // GET     Get game info: api/client/{clientId}/games/{gameId}
  getGame$(clientId: string, gameId: string): Observable<any> {
    return this.http.get(`https://dbndapi.azurewebsites.net/api/client/${clientId}/games/${gameId}`);
  }
  ...
  addCharacterToGame$(clientId: string, gameId: string, characterId: string) {
    return this.http.put(`https://dbndapi.azurewebsites.net/api/client/${clientId}/games/${gameId}/addCharacter/${characterId}`, null);
  }

  // PUT     Update game info: api/client/{clientId}/games/{gameId}/update
  updateGame$(clientId: string, gameId: string, game: Game) {
    return this.http.put(`https://dbndapi.azurewebsites.net/api/client/${clientId}/games/${gameId}/update`, game);
  }
  
  // DELETE  Delete game: api/client/{gameId}/games/{gameId}/delete
  deleteGame$(clientId: string, gameId: string): Observable<any> {
    return this.http.delete(`https://dbndapi.azurewebsites.net/api/client/${clientId}/games/${gameId}/delete`);
  }
...
// Overviews (of a game):
  ...
  createOverview$(clientId: string, gameId: string, overview: Overview): Observable<any> {
    return this.http.post(`https://dbndapi.azurewebsites.net/api/client/${clientId}/games/${gameId}/overviews/new`, overview);
  }
  ...
  getGameOverviews$(clientId: string, gameId: string): Observable<any> {
    return this.http.get(`https://dbndapi.azurewebsites.net/api/client/${clientId}/games/${gameId}/overviews`)
  }
  ...
  getOverview$(clientId: string, gameId: string, overviewId: string): Observable<any> {
    return this.http.get(`https://dbndapi.azurewebsites.net/api/client/${clientId}/games/${gameId}/overviews/${overviewId}`)
  }
  ...
  updateGameOverview$(clientId: string, gameId: string, overviewId: string, overview: Overview) {
    return this.http.put(`https://dbndapi.azurewebsites.net/api/clien/${clientId}/games/${gameId}/overviews/${overviewId}/update`, overview);
  }
  ...
  deleteOverview$(clientId: string, gameId: string, overviewId: string): Observable<any> {
    return this.http.delete(`https://dbndapi.azurewebsites.net/api/client/${clientId}/games/${gameId}/overviews/${overviewId}/delete`);
  }
